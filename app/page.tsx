      ...
      {showMore ? (
        ...
        <div>
          ...
          <ul className="list-none ml-0 pl-[1em] indent-[-1em] mt-4 leading-[1.4]">
            ...
            <li className="mt-4"><strong>-</strong> At U of M, I&apos;ve been involved in{' '}<TextScrambleLink href="https://v1michigan.com/">V1</TextScrambleLink>, {' '}<TextScrambleLink href="https://www.michiganfashionmediasummit.com/">MFMS</TextScrambleLink>, {' '}<TextScrambleLink href="https://alphathetadeltaumich.org/">ATD</TextScrambleLink>, and {' '}<TextScrambleLink href="https://www.mjia.org/">MJIA</TextScrambleLink>.</li>
