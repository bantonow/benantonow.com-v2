      ...
      {showMore ? (
        ...
        <div>
          ...
          <ul className="list-none ml-0 pl-[1em] indent-[-1em] mt-4 leading-[1.4]">
            ...
            <li className="mt-4"><strong>-</strong> A few other organizations have been kind enough employ me, including a health-tech spin-off from {' '}<TextScrambleLink href="https://jupyter.org/">Project Jupyter</TextScrambleLink>. More{' '}<TextScrambleLink href="/resume.pdf">here</TextScrambleLink>.</li>
