      ...
      {showMore ? (
        <div>
          ...
          <div className="leading-[1.4] space-y-4">
            <p>I&apos;m studying Computer Science and Cognitive Science with a business minor at the University of Michigan, in my Junior year.</p>
            ...
            <p>I&apos;m a TA for {' '}<TextScrambleLink href="https://eecs280.org/">EECS 280</TextScrambleLink>, the 3rd largest course at Michigan. I teach a lab section and do whatever I can to be an impactful teacher and mentor for my students.</p>
            <p>I spent last summer at UC Berkeley working at an open-source health tech initiative within {' '}<TextScrambleLink href="https://jupyter.org/">Project Jupyter</TextScrambleLink>. It&apos;s called {' '}<TextScrambleLink href="https://jupyterhealth.org/">JupyterHealth</TextScrambleLink>. I also had the privilege of taking an <TextScrambleLink href="https://cs61c.org/">incredible computer architecture class</TextScrambleLink>.</p>
